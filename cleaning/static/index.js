...
const starFour = document.querySelector('#star-three')
const starFive = document.querySelector('#star-three')
...
// show four stars
emptyStarFour.addEventListener('click', () => {
...
// show five stars
emptyStarFive.addEventListener('click', () => {
